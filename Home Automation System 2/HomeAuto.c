...
void main(){
	P0=0XFF;//SETTING ALL PINS OF PORT0 TO 0;
...
//and the transmission pin of the module is connected to the P3 pin 0 signal socket as it is the bluetooth receiving pin of the board
